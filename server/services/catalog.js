/**
 * Server-side catalog for price integrity.
 * Keep prices/sizes aligned with src/data/siteData.js productCatalog.
 */

/** Names/prices/sizes must match src/data/siteData.js productCatalog */
const CATALOG = [
